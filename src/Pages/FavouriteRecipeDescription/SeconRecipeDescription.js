...
export default function SeconRecipeDescription({ navigation, route }) {
       ...
       const userfavourites = firebaseobect.doc(uniq);
        userfavourites
            .set({
                ...
                cookingtime: route?.params?.cookingtime,
                servingsize: route?.params?.servingsize,
